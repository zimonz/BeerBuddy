            ...
            <v-row justify="center">
                <v-col lg="12" md="12" sm="12">
                    <v-card class="pa-4" tile>
                        ...
                        <v-autocomplete v-model="participants" :disabled="isUpdating" :items="allUsers" item-text="name" item-value="id" label="Participants" dense multiple chips small-chips deletable-chips reactive :search-input.sync="searchInput" @change="searchInput=''"></v-autocomplete>
